...
import { getTodo, getTodos, createTodo, updateTodo, deleteTodo, updateToggle } from "../controllers/todosController.js";
...
router.put("/update/toggle/:id", authorize,updateToggle)
